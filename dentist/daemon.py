...
def watch():
    ...
    if len(diff) == 0:
        ...
        send_email(text, ["happyyuwei1994@qq.com", "1257064323@qq.com"], "happyyuwei1994@qq.com")
        print(text)
...
def main():
    ...
    while True:
        ...
        sleep_time = 5+int(random.random()*5)
